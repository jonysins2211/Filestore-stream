...
async def start_command(client: Client, message: Message):
        ...
        if _LOG_CHANNEL:
            try:
                ...
                await client.send_message(
                    ...
                    f"📅 <b>Joined:</b> {__import__('datetime').datetime.now().strftime('%d %b %Y %H:%M')}",
    ...
    if len(text) > 7:
        ...
        reply_markup = InlineKeyboardMarkup(
            [
                    [InlineKeyboardButton("• ᴄʜᴀɴɴᴇʟs •", url="https://t.me/Movie_loverzz")],
